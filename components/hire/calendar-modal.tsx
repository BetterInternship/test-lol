...
export default function CalendarModal({ isOpen, onClose, applicantName }: CalendarModalProps) {
  ...
  const calendarDays = [
    { day: 23, isCurrentMonth: false }, { day: 24, isCurrentMonth: false }, { day: 25, isCurrentMonth: false }, 
    ...
    { day: 3, isCurrentMonth: false }, { day: 4, isCurrentMonth: false }, { day: 5, isCurrentMonth: false },
  ]
      ...
      <DialogContent className="max-w-5xl max-h-[95vh] p-0 bg-white">
        <div className="flex flex-col h-[90vh]">
          ...
          <div className="px-8 pt-6 pb-4 border-b flex-shrink-0">
            <DialogTitle className="text-2xl font-bold">Schedule an Interview</DialogTitle>
          </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-7 gap-2">
                          {calendarDays.map((date, index) => (
                            <button
                              key={index}
                              onClick={() => date.isCurrentMonth ? setSelectedDate(date.day) : null}
                              className={`
