...
export type DockProps = {
  ...
  showOnlyMobile?: boolean; // New prop to control mobile-only display
};
...
export default function Dock({
  ...
  baseItemSize = 50,
  dockHeight = 256,
  showOnlyMobile = true, // Default to mobile-only
}: DockProps) {
  ...
  // Don't render if showOnlyMobile is true and screen is larger than 1024px
