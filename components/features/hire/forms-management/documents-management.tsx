...
const mockStudents = [
    { id: "bowei-gai", name: "Bowei Gai", src: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde" },
    { id: "elara-vance", name: "Elara Vance", src: "https://images.unsplash.com/photo-1494790108377-be9c29b29330" },
    { id: "liam-chen", name: "Liam Chen", src: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e" },
    { id: "aria-kim", name: "Aria Kim", src: "https://images.unsplash.com/photo-1580489944761-15a19d654956" },
    { id: "javier-rodriguez", name: "Javier Rodriguez", src: "https://images.unsplash.com/photo-1633332755192-727a05c4013d" },
    { id: "sofia-petrov", name: "Sofia Petrov", src: "https://images.unsplash.com/photo-1544005313-94ddf0286df2" },
    { id: "caleb-jones", name: "Caleb Jones", src: "https://images.unsplash.com/photo-1527980965255-d3b416303d12" },
    { id: "nora-patel", name: "Nora Patel", src: "" },
    { id: "owen-miller", name: "Owen Miller", src: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d" },
];
...
const DocumentsManagement = () => {
    ...
    const handleAutomateAndDownloadZip = async (form: InternshipDataForm) => {
        ...
        for (const intern of form.interns) {
            try {
                ...
                if (!response.ok) {
                    throw new Error(`Failed to fetch ${form.pdfUrl}: ${response.statusText}`);
                }
    ...
    return (
        <div className="container mx-auto p-4 sm:p-6 lg:p-8">
            ...
            <ModeToggle isTrustMode={isTrustMode} onToggle={setIsTrustMode} className="hidden" />

            {isTrustMode ? (
                <TrustModeTable students={mockStudents} internshipData={internshipData} />
            ) : (
                <Accordion type="multiple" defaultValue={internshipData.map((category) => category.id)}  className="w-full">
                    {internshipData.map((category) => (
                        <AccordionItem key={category.id} value={category.id} className="mb-4 border rounded-lg shadow-sm">
                                ...
                                <Card className="border-none shadow-none rounded-t-none">
                                    <div className="overflow-x-auto">
                                        <Table>
                                            <TableHeader>
                                                <TableRow>
                                                    <TableHead className="w-[40%] sm:w-[50%]">Form Name</TableHead>
                                                    <TableHead className="w-[30%] sm:w-[30%]">Forms Needed By</TableHead>
                                                    <TableHead className="w-[30%] sm:w-[20%] text-center">Automate</TableHead>
                                                </TableRow>
                                            </TableHeader>
                                            <TableBody>
                                                    ...
                                                    <TableRow key={formIndex}>
                                                        <TableCell className="font-medium py-3">
                                                            ...
                                                            >
                                                                ...
                                                                <span className="break-words">{form.prefix}{form.baseName}</span>
                                                            </a>
                                                        </TableCell>
                                                        <TableCell className="py-3">
                                                            <div className="flex items-center -space-x-2">
                                                                {form.interns.slice(0, 3).map((intern, internIndex) => (
                                                                    <Tooltip key={internIndex}>
                                                                        <TooltipTrigger asChild>
                                                                            <Avatar className="h-7 w-7 border-2 border-background">
                                                                                <AvatarImage src={intern.src} alt={intern.name} />
                                                            ...
                                                            <Tooltip>
                                                                <TooltipTrigger asChild>
                                                                    <Button
                                                                        variant="ghost"
                                                                        size="icon"
                                                                        onClick={() => handleAutomateAndDownloadZip(form)}
                                                                        className="h-8 w-8"
                                                                    >
                                                                ...
                                                                <TooltipContent>
                                                                    <p>Automate & Download All Pre-filled Forms</p>
                                                                </TooltipContent>
                                                            </Tooltip>
                                                        </TableCell>
                                                    </TableRow>
