...
const Table = dynamic(() => import("@/components/features/school/ui/table").then((mod) => mod.Table), { ssr: false })
...
import { TableSkeleton } from "@/components/features/school/skeletons/table"
