      ...
      <div className="grid grid-cols-2 gap-6">
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              handleSignatoryChange("signatoryName", e.target.value)
            }
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              handleSignatoryChange("governmentId", e.target.value)
            }
        ...
        <div>
          ...
          <div className="relative">
            ...
            >
              ...
              {signatoryData.eSignature
                ? signatoryData.eSignature.name
                : "Upload File"}
            </Button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-6 mb-6">
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                handleProjectChange("numberOfStudents", e.target.value)
              }
              placeholder="e.g., 2"
              className="w-full"
            />
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                handleProjectChange("projectDuration", e.target.value)
              }
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                handleProjectChange("expectedOutputs", e.target.value)
              }
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          <div>
            ...
            <Textarea
              ...
              onChange={(e) =>
                handleProjectChange("projectActivities", e.target.value)
              }
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          <div>
            ...
            <Textarea
              ...
              onChange={(e) =>
                handleProjectChange("trainingSchedule", e.target.value)
              }
          ...
          <div>
            ...
            <Textarea
              ...
              onChange={(e) =>
                handleProjectChange("learningObjectives", e.target.value)
              }
